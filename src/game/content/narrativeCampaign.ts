...
export const NARRATIVE_SITE_BY_LEVEL: Readonly<Record<LevelId, NarrativeSiteId>> = {
  ...
  cordon_41: "cordon_41",
  junction_l6: "junction_l6",
  pell_cut: "pell_cut",
  station_14: "station_14",
  vasker_store: "vasker_store",
  lane_six: "lane_six",
  pell_cordon: "pell_cordon",
};

export const EVENT_MESSAGES = {
  "events.common.vessel": "vessel",
  "events.zone.upper": "upper",
  "events.zone.lower": "lower",
  "events.damage.tower_flash": "flash chamber",
  "events.damage.tower_caustic": "caustic jet",
  "events.damage.tower_burner": "carbon burner",
  "events.damage.tower_acid": "acid pot",
  "events.damage.tower_quench": "quench coil",
  "events.damage.tower_wash": "wash head",
  "events.damage.tower_marker": "carbonyl marker",
  "events.damage.tower_neutralization": "neutralization burst",
  ...
  "events.defeat.detail":
    "The Core fell during {level}, round {round}. The operation checkpoint is ready for another attempt.",

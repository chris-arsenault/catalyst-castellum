export const NARRATIVE_MESSAGES = {
  "narrative.acts.good_standing.name": "Act I · Good Standing",
  "narrative.acts.good_standing.summary":
    "Four contracts, a clean ledger, and the standing to file a claim under your own name.",
  ...
  "narrative.acts.same_grade.introduction.1":
    "The crew leaves the Long Rake with a clean record and a set of instrument logs nobody can explain. Samples cut from different claims react at the same instant, though they sit in sealed cases in separate rooms. T’kesh can repeat the result on demand. What no one aboard can say is what still connects them — the material, the cutter, or something the process itself is doing.",
  "narrative.acts.same_grade.introduction.2":
    "The two strangers on the comm have stopped pretending to be casual. Surveyor asks for raw records and warns against anything larger. Buyer offers enough to clear the vessel’s debt outright, if the crew can prove the process at industrial scale. Kettleblack is where both of them expect an answer.",
  "narrative.acts.new_boundary.name": "Act III · A New Boundary",
  ...
  "narrative.speakers.surveyor.role": "Encrypted caller",
  "narrative.speakers.buyer.name": "Buyer",
  "narrative.speakers.buyer.role": "Private client",
  "narrative.speakers.vela_norr.name": "Vela Norr",
  "narrative.speakers.vela_norr.role": "Displacement Council remote-operations engineer",
  "narrative.speakers.daro_venn.name": "Daro Venn",
  "narrative.speakers.daro_venn.role": "Coremark route officer",
  "narrative.speakers.kethra.name": "Kethra",
  "narrative.speakers.kethra.role": "Displacement Council cordon captain",
  "narrative.speakers.soft_wake.name": "Soft Wake",
  ...
  "narrative.sites.harkers_brace.contract": "Licensed brine recovery",
  "narrative.sites.harkers_brace.briefing":
    "Harker’s Brace is a broken salt refinery folded around a pocket of clean brine, and the whole wreck is drifting out of the marked lane. The contract pays for the recovered chemicals, with a bonus for speed: crack the reservoir, run the brine through the plant, and be gone before the tow window closes.",
  "narrative.sites.twelve_cask.name": "Twelve-Cask",
  "narrative.sites.twelve_cask.code": "RAT-12C",
  "narrative.sites.twelve_cask.region": "Caskward Drift",
  "narrative.sites.twelve_cask.contract": "Industrial chemical salvage",
  "narrative.sites.twelve_cask.briefing":
    "Twelve-Cask is a freight store abandoned with its inventory intact. A dozen small tanks still hold a chlorine-rich cleaning stock, some of it already weeping into the lower deck, and the salvage board wants the chemicals recovered and every stamped serial plate on record.",
  "narrative.sites.morrow_pocket.name": "Morrow Pocket",
  "narrative.sites.morrow_pocket.code": "IND-MP7",
  ...
  "narrative.sites.cordon_41.contract": "Council sensor recovery",
  "narrative.sites.cordon_41.briefing":
    "Cordon 41 is a closed Council test site where the instruments have stopped agreeing with the walls. A damaged sensor array is still transmitting from inside the unstable zone — reporting the same wall in two locations — and Vela Norr wants it brought out by a machine instead of a person.",
  "narrative.sites.junction_l6.name": "Junction L-6",
  "narrative.sites.junction_l6.code": "CM-L06",
  ...
  "narrative.sites.station_14.contract": "Council beacon recovery",
  "narrative.sites.station_14.briefing":
    "Station 14 is a Council monitoring post caught inside the new distortion at Pell. Three navigation beacons are still transmitting from rooms the map can no longer place. Kethra sends the cutter in ahead of her rescue crews — machines first, people after.",
  "narrative.sites.vasker_store.name": "Vasker Store",
  "narrative.sites.vasker_store.code": "DC-VS3",
  ...
  "narrative.dialogue.claim_8_delta.briefing.empty_spine":
    "Cutter’s linked and ready. The station won’t take boarders, but the machine can go in through a service hatch and open the tanks from inside. Anything that’s made a home in there will follow it back toward our defense rooms.",
  "narrative.dialogue.claim_8_delta.briefing.read_from_core":
    "I’ll watch the cutter’s link from here. Routine claim — my work is making sure the signal holds while the station comes apart around the machine. The plant is yours.",
  ...
  "narrative.dialogue.harkers_brace.briefing.cell_train":
    "The refinery’s intake pipe is intact, so I can feed its brine straight into our membrane cell. We’ll get chlorine, hydrogen, and caustic soda from the same run. I’ve marked the connections you need to open.",
  "narrative.dialogue.harkers_brace.briefing.quiet_beyond_cut":
    "I checked the cutter before launch. Its clock is accurate again, and I’ve added a second recorder in case those missing seconds return. Once is a fault; twice is something worth understanding.",
  ...
  "narrative.dialogue.twelve_cask.briefing.raw_return":
    "Keep the extra clock recorder running from launch to recovery. I want to see when the missing time begins, when it ends, and whether moving the chemicals between rooms changes it. I’ll pay the same rate as I did for Harker’s Brace.",
  "narrative.dialogue.twelve_cask.briefing.discard_premium":
    "Your assay will leave a dark residue after the useful chlorine is removed. Seal that residue in a sample case and send it to my courier. I’m offering more for the sample than the board is paying for the rest of the claim.",
  "narrative.dialogue.twelve_cask.debrief.same_harmonic":
    "I tested the recovered cleaner and the dark residue in separate rooms. When I excited one sample, the other reacted at exactly the same moment. A wall, two sealed cases, and twenty meters of distance produced identical timing.",
  "narrative.dialogue.twelve_cask.debrief.receipt_cleared":
    "The sample arrived in good condition, and your payment has cleared. Keep my channel open. I have access to larger sites if your crew is willing to prove this process can handle them.",
  "narrative.dialogue.twelve_cask.debrief.preserve_timing":
    "Please keep the cutter’s clock and both samples isolated from the ship’s network. We have a repeatable result now, and I want the next test to tell us whether the connection comes from the material or from your equipment.",

  "narrative.dialogue.morrow_pocket.briefing.solo_claim":
    "Morrow Pocket belongs to your crew from filing to sale. Finish this one cleanly and you’ll have enough standing to bid on claims under your own name. I’ll still answer the comm when you need an old Ratter’s opinion.",
  "narrative.dialogue.morrow_pocket.briefing.complete_return":
    "Use every stage of the plant and keep a sample from each product. The earlier tests suggest that processing changes how the material appears, but some connection survives underneath. A complete run lets me see where that connection weakens.",
  "narrative.dialogue.morrow_pocket.briefing.sealed_fraction":
    "I want the final residue again, sealed with the grey clasp my courier supplied. If it still reacts to the other samples after a full processing run, I’ll double the fee and offer your crew an industrial contract.",
  "narrative.dialogue.morrow_pocket.debrief.one_grade":
    "I understand what the instruments are showing now. The products look different after processing, but they still behave like pieces of the same original sample. We are separating the material here while part of its behavior remains shared.",
  "narrative.dialogue.morrow_pocket.debrief.buyer_knows_next":
    "I checked Buyer’s sample clasp. It came through the Coremark freight office at Pell, and the shipping date is older than our first conversation with him. He was looking for this result before he knew our crew existed.",
  "narrative.dialogue.morrow_pocket.debrief.boundary_request":
  ...
  "narrative.dialogue.kettleblack.briefing.field_has_edges":
    "The deposits are reacting in pairs. One member of each pair is inside Kettleblack, while the instruments point toward a second location farther along the Pell route. That should be impossible, which makes Surveyor’s map more important than Buyer’s deadline.",
  "narrative.dialogue.kettleblack.debrief.unauthored_pattern":
    "Something sent a control pulse back through the cutter after we closed the last tank. It used our equipment address, but the command history contains nothing that could have caused it. I’ve locked the cutter out of the main network until we know where it came from.",
  "narrative.dialogue.kettleblack.debrief.council_channel":
    "Incoming priority call. The sender is using a verified Displacement Council engineering channel.",
  "narrative.dialogue.kettleblack.debrief.meeting_offer":
    "You kept careful records and stopped when the return signal changed. That is why I chose a working crew over a laboratory. My name is Vela Norr. Meet me at Cordon 41 and I’ll show you what your cutter has been touching.",

  "narrative.dialogue.cordon_41.briefing.identity":
    "I run remote operations for the Displacement Council. I used the name Surveyor because your method was untested, and an official request would have buried both of us in hearings before I had evidence worth presenting.",
  "narrative.dialogue.cordon_41.briefing.reach_costs_people":
    "When a Bloom boundary moves, someone has to enter it and place new sensors by hand. Your cutter reached through a smaller version of that distortion while your crew stayed safely aboard. I need to learn whether we can do that deliberately.",
  ...
  "narrative.dialogue.cordon_41.debrief.buyer_trace":
    "Buyer’s channel has been identified. It belongs to Daro Venn, a route officer in Coremark’s Pell freight division.",

  "narrative.dialogue.junction_l6.briefing.identity":
    "My name is Daro Venn. I run freight routes for Coremark now, but I spent eleven years cutting salvage claims before I took this desk. I know exactly why your crew built a machine that can enter a site in your place.",
  "narrative.dialogue.junction_l6.briefing.scale_solves_exposure":
    "Every dangerous site eventually costs someone a hand, a lung, or a life. A remote machine can be replaced. If your method works at the scale of a real mine, thousands of workers can earn a living from a safer distance.",
  "narrative.dialogue.junction_l6.briefing.left_clean":
    "Daro’s old claim record is clean, and the crews who worked with him came home. I trust that part of the man. Coremark pays him to think in cargo volume now, so make him explain every shortcut before you agree to it.",
  "narrative.dialogue.junction_l6.debrief.test_scheduled":
    "The qualification run passed. I’ve reserved Pell Cut for the full trial: four mining arrays, a steady industrial feed, and one shift to prove the process. Complete it and the balance on your vessel is cleared.",
  "narrative.dialogue.junction_l6.debrief.samples_answer":
    "The samples reacted across the entire junction. Pell Cut would connect four arrays around the same deposit, making the effect far stronger than anything we have tested. I want authority to stop the trial the moment that connection begins to spread.",
  "narrative.dialogue.junction_l6.debrief.choose_distance":
  ...
  "narrative.dialogue.pell_cut.briefing.pattern_listens":
    "The idle arrays are already repeating the timing of our pumps. They learned it during the junction test. Once we start, change the cycle if you hear the same rhythm coming back through the cutter.",
  ...
  "narrative.dialogue.station_14.briefing.cutter_first":
    "The cutter goes first because I can afford to lose a machine. I’ll keep a recovery line on it, and my crews pull it out if the route begins to close. Your job is to keep that route clear while it works.",
  "narrative.dialogue.station_14.briefing.two_boundaries":
    "Station 14 appears in two places on our map, but both readings lead to the same rooms inside. I can keep one route stable for about eleven minutes. Follow my markers even when the camera shows a door somewhere else.",
  ...
  "narrative.dialogue.vasker_store.briefing.grain_locus":
    "Vasker Store holds treated ringglass that dampens nearby resonance. I can build a closure device from that stock, but I need the original inventory labels so I know how each batch was prepared.",
  "narrative.dialogue.vasker_store.briefing.room_overlap":
    "The building is shifting between two layouts. The far wall of one storage room is also the near wall of the next, and the relationship changes every few minutes. I’ll guide the cutter by landmarks that remain true in both versions.",
  ...
  "narrative.dialogue.lane_six.briefing.hold_real_boundary":
    "I’ll place a white line on your map that marks the route shared by every version of Lane Six. Follow that line when doors move or rooms repeat. The camera can lie here; the shared route cannot.",
  "narrative.dialogue.lane_six.debrief.lane_secure":
    "Lane Six is clear, and the full cordon has reached its final position. The route back is marked and every crew has confirmed the withdrawal signal.",
  "narrative.dialogue.lane_six.debrief.pell_stabilizing":
    "The distortion is settling around the Near Voice. If it holds this shape through another full cycle, Pell becomes a permanent Bloom. Vela’s device must interrupt it during the next run.",
  "narrative.dialogue.lane_six.debrief.final_authorization":
  ...
  "narrative.dialogue.pell_cordon.debrief.bring_people_home":
    "Final count complete. Every Council crew and every civilian we found has returned across Lane Six. Your cutter is the only machine we left behind.",
  "narrative.dialogue.pell_cordon.debrief.new_method_recorded":
    "Your remote process is entering the Council’s containment manual, with the shutdown rules we learned here attached to it. The next cordon can reach farther while keeping more people outside the boundary.",
  "narrative.dialogue.pell_cordon.debrief.debt_remains":
    "Coremark has suspended my office and opened an inquiry into the scale test. That is fair. I still owe your crew the payment I promised, and I intend to make sure the company pays it.",

  "narrative.ui.act.eyebrow": "Campaign",
  "narrative.ui.act.continue": "Answer contract call",
  "narrative.ui.briefing.channel": "Incoming call",
  ...
  "narrative.ui.progress.ledger":
    "Morrow Pocket closes the ledger Malk opened. Kettleblack’s coordinates are logged in the operations record, and Surveyor is still waiting on an answer.",
} as const;
